...
// todo: make a much less naive content size estimate. will probably need to use the built data after its made, and then have some predicted sizes for react components
